...
public class NGramMapTest {
    ...
    @Test
    public void test() {
        NGramMap ngrm = new NGramMap(WORD_HISTORY_SIZE14377_FILE, YEAR_HISTORY_FILE);
        IO.println(ngrm.weightHistory("cat", 2000, 2020).toString());
        IO.println(ngrm.weightHistory("dog", 2000, 2020).toString());
    }
}
